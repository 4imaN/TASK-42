...
- **My Understanding:** Everything must run locally on a machine or LAN.
- **Solution:** Use only local services (Spring Boot, MySQL, JWT, storage, etc.), no external dependencies.

---

### 2. Where does the recyclable item catalog come from?
- **Problem:** Source of catalog not defined (remote vs local).
- **My Understanding:** Must work immediately offline.
...
- **My Understanding:** Use local activity data.
...
- **My Understanding:** Must be locally generated and auditable.
...
- **My Understanding:** Must be configurable and deterministic.
...
- **My Understanding:** Order stays constant, appointment evolves.
...
- **My Understanding:** Fix transaction without changing catalog.
...
- **My Understanding:** Contracts must remain stable.
...
- **My Understanding:** Must work offline in browser.
...
- **My Understanding:** Must be secure and auditable.
...
- **My Understanding:** Default masked, explicit reveal by admin.
...
- **My Understanding:** Needs flexible admin control.
...
- **My Understanding:** Post-transaction dispute handling.
...
- **My Understanding:** Search broad, dedupe controlled.
...
- **My Understanding:** Must auto-generate securely.
...
- **My Understanding:** Must work out-of-the-box.
...
- **My Understanding:** Needs default and configurable value.
...
- **My Understanding:** Only essential features should be included.
